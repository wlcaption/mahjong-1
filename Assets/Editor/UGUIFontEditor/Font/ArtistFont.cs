...
{	public static void BatchCreateArtistFont()
	{
		...
		{
            //BMFontText = Resources.LoadAssetAtPath(fntFileName, typeof(TextAsset)) as TextAsset;
            //BMFontText = Resources.LoadAssetAtPath(fntFileName, typeof(TextAsset)) as TextAsset;
		...
		Material mat = null;
		{
			...
			//Texture tex = Resources.LoadAssetAtPath(textureFilename, typeof(Texture)) as Texture;
            Texture tex = UnityEditor.AssetDatabase.LoadAssetAtPath(fntFileName, typeof(Texture)) as Texture;
