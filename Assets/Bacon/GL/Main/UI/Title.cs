...
public class Title : MonoBehaviour {
    ...
    public void OnShare() {
        _UIRoot.GetComponent<Bacon.GL.Main.UI.UIRoot>().OnShare();
    }

    public void OnRecored() {
        _UIRoot.GetComponent<UIRoot>().OnRecored();
    }

    public void OnMsg() {
        _UIRoot.GetComponent<UIRoot>().OnMsg();
    }

    public void OnRule() {
        _UIRoot.GetComponent<UIRoot>().OnRule();
    }

    public void OnSetting() {
        _UIRoot.GetComponent<UIRoot>().OnSetting();
    }

    public void OnAdd() {
        _UIRoot.GetComponent<UIRoot>().OnAdd();
    }
}
}