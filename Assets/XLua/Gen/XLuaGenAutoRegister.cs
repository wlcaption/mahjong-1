    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(Bacon.Service.InitService), BaconServiceInitServiceWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(Maria.Util.ABLoader), MariaUtilABLoaderWrap.__Register);
