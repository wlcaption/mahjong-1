...
namespace XLua.CSObjectWrap
{
    ...
    public class BaconMainControllerWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(Bacon.MainController), L, translator, 0, 37, 0, 0);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Adver", _m_Adver);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Board", _m_Board);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RenderAdver", _m_RenderAdver);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RenderBoard", _m_RenderBoard);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Adver(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.Adver( responseObj );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Board(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.Board( responseObj );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RenderAdver(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.RenderAdver(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RenderBoard(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.RenderBoard(  );
