...
namespace XLua.CSObjectWrap
{
    ...
    public class MariaApplicationWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(Maria.Application), L, translator, 0, 6, 1, 0);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			try {
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<App>(L, 2))
				{
					App app = (App)translator.GetObject(L, 2, typeof(App));
