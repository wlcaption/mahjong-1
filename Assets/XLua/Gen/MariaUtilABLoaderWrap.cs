...
namespace XLua.CSObjectWrap
{
    ...
    public class MariaUtilABLoaderWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(Maria.Util.ABLoader), L, translator, 0, 3, 0, 0);
			...
			Utils.EndObjectRegister(typeof(Maria.Util.ABLoader), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(Maria.Util.ABLoader), L, __CreateInstance, 1, 1, 1);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(Maria.Util.ABLoader));
			...
			Utils.EndClassRegister(typeof(Maria.Util.ABLoader), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Maria.Util.ABLoader __cl_gen_ret = new Maria.Util.ABLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Maria.Util.ABLoader constructor!");
        ...
        static int _g_get_current(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    translator.Push(L, Maria.Util.ABLoader.current);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_current(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    Maria.Util.ABLoader.current = (Maria.Util.ABLoader)translator.GetObject(L, 1, typeof(Maria.Util.ABLoader));
