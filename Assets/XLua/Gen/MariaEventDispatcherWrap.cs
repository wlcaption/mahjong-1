...
namespace XLua.CSObjectWrap
{
    ...
    public class MariaEventDispatcherWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(Maria.EventDispatcher), L, translator, 0, 4, 0, 0);
            ...
            try {
                
                {
                    ...
                    object ud = translator.GetObject(L, 4, typeof(object));
                        ...
                        Maria.EventListenerCustom __cl_gen_ret = __cl_gen_to_be_invoked.AddCustomEventListener( eventName, callback, ud );
                        translator.Push(L, __cl_gen_ret);
