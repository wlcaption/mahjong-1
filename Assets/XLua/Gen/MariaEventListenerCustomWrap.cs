...
namespace XLua.CSObjectWrap
{
    ...
    public class MariaEventListenerCustomWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(Maria.EventListenerCustom), L, translator, 0, 0, 1, 0);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			try {
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<Maria.EventListenerCustom.OnEventCustomHandler>(L, 3))
				{
					...
					Maria.EventListenerCustom __cl_gen_ret = new Maria.EventListenerCustom(name, callback);
