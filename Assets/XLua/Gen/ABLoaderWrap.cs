...
namespace XLua.CSObjectWrap
{
    ...
    public class ABLoaderWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			Utils.BeginObjectRegister(typeof(ABLoader), L, translator, 0, 4, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "FetchVersion", _m_FetchVersion);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LoadPath", _m_LoadPath);
			...
			Utils.EndObjectRegister(typeof(ABLoader), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(ABLoader), L, __CreateInstance, 1, 1, 1);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(ABLoader));
			...
			Utils.EndClassRegister(typeof(ABLoader), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					ABLoader __cl_gen_ret = new ABLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ABLoader constructor!");
        ...
        static int _m_FetchVersion(RealStatePtr L)
        {
            ...
            ABLoader __cl_gen_to_be_invoked = (ABLoader)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LoadPath(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.LoadPath(  );
        ...
        static int _g_get_current(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    translator.Push(L, ABLoader.current);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_current(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    ABLoader.current = (ABLoader)translator.GetObject(L, 1, typeof(ABLoader));
