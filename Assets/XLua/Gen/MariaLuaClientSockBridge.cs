...
{
    public class MariaLuaClientSockBridge : LuaBase, Maria.Lua.ClientSock
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new MariaLuaClientSockBridge(reference, luaenv);
		}
		
		public MariaLuaClientSockBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		...
		public bool enable()
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
				...
				LuaAPI.xlua_pushasciistring(L, "enable");
				...
				{
					LuaAPI.xlua_pushasciistring(L, "no such function enable");
					luaEnv.ThrowExceptionFromError(err_func - 1);
				}
